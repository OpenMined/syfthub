  ...
  return (
    <div className='flex min-h-[60vh] flex-col items-center justify-center px-6 py-16'>
      <div className='text-center'>
        ...
        {/* Title */}
        <h1 className='font-rubik text-foreground mb-2 text-4xl font-semibold'>404</h1>
        <h2 className='font-rubik text-foreground mb-4 text-xl font-medium'>Page Not Found</h2>

        {/* Description */}
        <p className='font-inter text-muted-foreground mx-auto mb-8 max-w-md'>
