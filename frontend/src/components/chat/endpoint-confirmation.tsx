        ...
        <div className='border-border flex items-center justify-between border-t bg-slate-50 px-4 py-3 dark:bg-slate-900/50'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <button
              ...
              className='font-inter bg-primary text-primary-foreground hover:bg-primary/90 flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-colors disabled:cursor-not-allowed disabled:opacity-50'
            >
