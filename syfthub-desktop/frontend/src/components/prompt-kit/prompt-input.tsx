...
function PromptInput({
  ...
  const handleClick: React.MouseEventHandler<HTMLDivElement> = (e) => {
    if (!disabled) textareaReference.current?.focus();
    onClick?.(e);
  };
...
function PromptInputTextarea({
  ...
  const handleReference = (element: HTMLTextAreaElement | null) => {
...
function PromptInputActions({ children, className, ...props }: Readonly<PromptInputActionsProps>) {
  return (
