  ...
  return (
    ...
    >
      <div className='grid grid-cols-[min-content_minmax(0,1fr)] gap-x-4'>
        <div className='bg-primary/20 ml-[0.4375rem] h-full w-px group-data-[last=true]:hidden' />
...
export function ChainOfThought({ children, className }: Readonly<ChainOfThoughtProps>) {
  ...
  return (
    <Collapsible className={cn('group', className)} data-last={isLast} {...props}>
      ...
      <div className='flex justify-start group-data-[last=true]:hidden'>
        <div className='bg-primary/20 ml-[0.4375rem] h-4 w-px' />
      </div>
    </Collapsible>
  );
};
