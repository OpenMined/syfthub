...
type EndpointBrowseTab = 'data_sources' | 'models' | 'agents';
type BrowseTab = EndpointBrowseTab | 'collectives';

/** Per-tab config for the endpoint tabs (the collectives tab is separate). */
...
> = {
  ...
  agents: { endpointType: 'agent', entityName: 'agents' }
};

/** Ordered tab strip — data sources, models, agents, then collectives. */
