...
func TestChatEventTypes(t *testing.T) {
	testCases := []struct {
		...
		{&RerankingStartEvent{}, ChatEventTypeRerankingStart},
		{&RerankingCompleteEvent{}, ChatEventTypeRerankingComplete},
		{&GenerationStartEvent{}, ChatEventTypeGenerationStart},
		{&GenerationHeartbeatEvent{}, ChatEventTypeGenerationHeartbeat},
